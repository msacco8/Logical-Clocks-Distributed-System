...
We started off this project by using the skeleton code provided on Canvas -- our first task was to understand exactly how this code worked so that we could know how to refactor it to fit the project. Here are the design choices we made during this refactoring:
